import { Download, DownloadIcon, ImageIcon, Loader2Icon } from "lucide-react";
import type { AspectRatio, IThumbnail } from "../assets/assets"


const PreviewPannel = ({thumbnail, isLoading, aspectRatio}: {thumbnail : IThumbnail | null, isLoading: boolean, aspectRatio: AspectRatio}) => {
        ...
        {isLoading && (
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-black/25">
            ...
            <div className="text-center">
              ...
              <p className="mt-1 text-xs text-zinc-400">This may take 10 to 20 seconds.</p>
            </div>
          </div>
        )}
        {/*Image preview */}
